...
@Serializable data class QuotationFollowUp(val date:String="",val notes:String="")
...
@Serializable data class ReturnCreateLine(val code:String="",val quantity:Double=1.0,val amount:Double=0.0,val reason:String?=null)
...
@Serializable data class ReturnUpdateRequest(val field:String="",val value:String="")
