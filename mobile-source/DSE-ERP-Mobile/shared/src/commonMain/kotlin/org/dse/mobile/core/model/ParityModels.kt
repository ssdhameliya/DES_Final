...
@Serializable data class PaymentRow(val id:Int=0,val date:String="",val reference:String="",val mode:String="",val amount:Double=0.0,val notes:String="",val receivedFrom:String="",val attachment:String="",val paymentType:String="")
...
@Serializable data class PaymentUpdateRequest(val date:String="",val amount:Double=0.0,val mode:String="",val reference:String="",val notes:String="",val receivedFrom:String="")
